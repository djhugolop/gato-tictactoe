...
xPhoto = PhotoImage(file = 'img/x.png')
oPhoto = PhotoImage(file = 'img/o.png')
...
def checkWin():
    ...
    if (btn1.get() == 'X' and btn2.get() == 'X' and btn3.get() == 'X' or
        ...
        tkinter.messagebox.showinfo("Hay ganador!", 'X Gana !')
        click = True
        count = 0
        clear()
        start()
          ...
          tkinter.messagebox.showinfo("Hay ganador!", 'O Gana !')
          count = 0
          clear()
          start()
          
    elif (count == 9):
         tkinter.messagebox.showinfo("Ufff!", 'Empate!')
         click = True
         count = 0
         clear()
         start()
